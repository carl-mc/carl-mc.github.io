...
{var $caret=this.$element.find('.caret');$caret.removeClass('is-left').addClass('is-down');}});})(Kube);;<script async src="https://www.googletagmanager.com/gtag/js?id=G-9PQK6NZNY8"></script><script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}
gtag('js',new Date());gtag('config','G-9PQK6NZNY8');</script>